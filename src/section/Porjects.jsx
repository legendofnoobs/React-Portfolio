...
const Projects = () => {
	return (
		<div className="max-w-[100rem] m-auto py-10 min-h-fit">
				...
				{projectsData.map(function(project, index){
					return (
						<motion.div 
							...
							className="hover:bg-black/10 hover:backdrop-blur-lg hover:border-white/10 border-2 border-transparent rounded-2xl hover:shadow-2xl hover:shadow-blue-500 transition ease max-[994px]:w-full w-[30rem]"
						>
							<ProjectCard 
